                    ...
                    children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10.0,),
                          Text("Casts", style: Theme.of(context).textTheme.caption.copyWith(
                                ...
                                return Container(
                                  child: Column(
                                    children: [
                                      ...
                                      Container(
                                        child: Center(
                                          child: Text((cast.name), style: TextStyle(fontSize: 10.0),),
                                        ),
                                      ),

                                      Container(
                                        child: Center(
                                          child: Text((cast.character), style: TextStyle(fontSize: 10.0),),
                                        ),
                                      ),
